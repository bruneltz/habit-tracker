...
export async function appRoutes(app: FastifyInstance) {
    ...
    app.get('/day', async (request) => {
        const getDayParams = z.object({
            // Coerce will converts the parameter in a date type
            date: z.coerce.date()
        })
    ...
    // patch means that a habit status will be changed
    //id é um parâmetro de identificação
