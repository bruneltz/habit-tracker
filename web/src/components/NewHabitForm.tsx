...
export function NewHabitForm() {
	...
	return (
		// Método onSubmit por padrão envia para outra tela, para evitar isso, é utilizado eventos
		<form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
			...
			<div className="flex flex-col gap-2 mt-3">
				{/* // a propriedade 'group' do tailwind espalha as propriedades */}
					...
					return (
						<Checkbox.Root
							...
							<div className='h-8 w-8 rounded-lg flex items-center justify-center bg-zinc-900 border-2 border-zinc-800
								...
								{/* //É possível fazer condições baseado em propriedades data-* */}
								<Checkbox.Indicator>
									<Check
										size={20}
			...
			<button type="submit" className="mt-6 rounded-lg p-4 flex items-center gap-3 font-semibold bg-green-600 justify-center hover:bg-green-500 transition-colors
			focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 focus:ring-offset-zinc-900"><Check size={20} weight="bold"></Check>Confirmar</button>
		</form>
	)
} 